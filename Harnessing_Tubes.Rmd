...
ggplot(number_errors, aes(x = Type_Har, y = total_errors, fill = Type_Har)) +
  ...
  theme_minimal(base_size = 14) + 
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_fill_manual(values = c("3D" = "#619CFF", "Metallic" = "#F8766D")) +
  guides(fill = "none")
